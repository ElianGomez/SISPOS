...
from PyQt5.QtWidgets import QTableWidgetItem, QMenu, QAction, QFileDialog, QShortcut, QCheckBox, QDesktopWidget
...
########################################################################################################################
    ...
    def SalvarFactura(self):
        try:
            ...
            if not numfac or not idcli or not monto or not balance or not ncf or not estatus:
                self.mensaje.setIcon(QMessageBox.Critical)
